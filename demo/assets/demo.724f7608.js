...
import { _ as _export_sfc, o as onBeforeMount, u as useTranslate, r as ref, c as createElementBlock, a as createBaseVNode, t as toDisplayString, b as openBlock } from "./mobile.1422d17f.js";
...
const _hoisted_20 = { class: "demo-buttons flex" };
const _hoisted_21 = {
  loading: "",
  loadtype: "circular",
  type: "danger"
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    createBaseVNode("div", _hoisted_17, [
      createBaseVNode("quark-button", _hoisted_18, toDisplayString(_ctx.translate("shape.square")), 1),
      createBaseVNode("quark-button", _hoisted_19, toDisplayString(_ctx.translate("shape.round")), 1)
    ]),
    createBaseVNode("h2", null, toDisplayString(_ctx.translate("title.loading")), 1),
    createBaseVNode("div", _hoisted_20, [
      createBaseVNode("quark-button", _hoisted_21, toDisplayString(_ctx.translate("loading")), 1),
      ...
      createBaseVNode("quark-button", {
        ...
        type: "success"
      }, toDisplayString(_ctx.translate("click")), 9, _hoisted_23)
    ]),
    createBaseVNode("h2", null, toDisplayString(_ctx.translate("title.icon")), 1),
    createBaseVNode("div", _hoisted_24, [
      createBaseVNode("quark-button", _hoisted_25, toDisplayString(_ctx.translate("like")), 1),
      createBaseVNode("quark-button", _hoisted_26, toDisplayString(_ctx.translate("name")), 1)
    ])
  ]);
}
