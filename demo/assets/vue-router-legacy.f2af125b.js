;(function(){System.register(['./mobile-legacy.76e3170c.js'],function(exports){'use strict';var inject,onUnmounted,onDeactivated,onActivated;return{setters:[function(module){inject=module.i;onUnmounted=module.g;onDeactivated=module.h;onActivated=module.j;}],execute:function(){exports('o',onBeforeRouteLeave);/*!
        * vue-router v4.1.6
