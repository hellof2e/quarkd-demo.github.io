import { _ as _export_sfc, r as ref, o as onBeforeMount, u as useTranslate, c as createElementBlock, a as createBaseVNode, t as toDisplayString, T as Toast, b as openBlock } from "./mobile.63f1796b.js";
import { c as createComponent } from "./component.31cc2671.js";
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    createBaseVNode("div", _hoisted_14, [
      createBaseVNode("quark-tabs", null, [
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[0]
        }, toDisplayString(_ctx.translate("tabs")[0]), 9, _hoisted_15),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[1]
        }, toDisplayString(_ctx.translate("tabs")[1]), 9, _hoisted_16),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[2]
        }, toDisplayString(_ctx.translate("tabs")[2]), 9, _hoisted_17),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[3]
        }, toDisplayString(_ctx.translate("tabs")[3]), 9, _hoisted_18),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[4]
        }, toDisplayString(_ctx.translate("tabs")[4]), 9, _hoisted_19),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[5]
        }, toDisplayString(_ctx.translate("tabs")[5]), 9, _hoisted_20),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[6]
        }, toDisplayString(_ctx.translate("tabs")[6]), 9, _hoisted_21),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[7]
        }, toDisplayString(_ctx.translate("tabs")[7]), 9, _hoisted_22),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[8]
        }, toDisplayString(_ctx.translate("tabs")[8]), 9, _hoisted_23),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[9]
        }, toDisplayString(_ctx.translate("tabs")[9]), 9, _hoisted_24)
      ])
    ]),
    ...
    createBaseVNode("div", _hoisted_25, [
      createBaseVNode("quark-tabs", {
        ...
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[0],
          name: "a"
        }, toDisplayString(_ctx.translate("tabs")[0]), 9, _hoisted_27),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[1],
          name: "b"
        }, toDisplayString(_ctx.translate("tabs")[1]), 9, _hoisted_28),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[2],
          disabled: _ctx.data.disabled,
          name: "c"
        }, toDisplayString(_ctx.translate("tabs")[2]), 9, _hoisted_29),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[3],
          name: "d"
        }, toDisplayString(_ctx.translate("tabs")[3]), 9, _hoisted_30)
      ], 40, _hoisted_26)
    ]),
    createBaseVNode("h2", null, toDisplayString(_ctx.translate("title.sticky")), 1),
    createBaseVNode("div", _hoisted_31, [
      createBaseVNode("quark-tabs", _hoisted_32, [
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[0]
