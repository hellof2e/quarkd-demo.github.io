;(function(){System.register(['./mobile-legacy.c0e3486b.js'],function(exports){'use strict';var inject,onUnmounted,onDeactivated,onActivated;return{setters:[function(module){inject=module.i;onUnmounted=module.e;onDeactivated=module.f;onActivated=module.g;}],execute:function(){exports('o',onBeforeRouteLeave);/*!
        * vue-router v4.1.3
