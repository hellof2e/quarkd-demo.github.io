;(function(){System.register(['./mobile-legacy.6e0196ea.js'],function(exports){'use strict';var inject,onUnmounted,onDeactivated,onActivated;return{setters:[function(module){inject=module.i;onUnmounted=module.h;onDeactivated=module.j;onActivated=module.k;}],execute:function(){exports('o',onBeforeRouteLeave);/*!
        * vue-router v4.1.3
