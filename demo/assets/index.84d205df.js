import { m as f, n as r$2, w, s, q as h, v as d, x as a$1 } from "./mobile.dd808505.js";
function r$1(n) {
  var i = function() {
  ...
  return function() {
    ...
    if (i) {
      ...
      o = Reflect.construct(s2, arguments, c);
    } else
...
var a = function(t) {
  ...
  function c() {
    var t2;
    return r$2(this, c), (t2 = e.call(this)).attachShadow({
      mode: "open"
...
customElements.get("quark-icon-home") || customElements.define("quark-icon-home", a);
function r(n) {
  var i = function() {
    if ("undefined" == typeof Reflect || !Reflect.construct)
      return false;
  ...
  return function() {
    ...
    if (i) {
      ...
      c = Reflect.construct(o, arguments, s2);
    } else
...
var l = function(t) {
  ...
  function s$1() {
    var t2;
    return r$2(this, s$1), (t2 = e.call(this)).attachShadow({
      mode: "open"
...
customElements.get("quark-icon-tel") || customElements.define("quark-icon-tel", l);
