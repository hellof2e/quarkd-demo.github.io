...
import { _ as _export_sfc, o as onBeforeMount, u as useTranslate, r as ref, c as createElementBlock, a as createBaseVNode, t as toDisplayString, b as openBlock } from "./mobile.6b10b621.js";
...
const _hoisted_17 = { class: "demo-buttons flex" };
const _hoisted_18 = {
  loading: "",
  loadtype: "circular",
  type: "danger"
...
const _hoisted_24 = { class: "demo-buttons" };
const _hoisted_25 = {
  type: "primary",
  size: "big"
};
const _hoisted_26 = { type: "primary" };
const _hoisted_27 = {
  type: "primary",
  size: "small"
};
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    createBaseVNode("div", _hoisted_7, [
      createBaseVNode("quark-button", _hoisted_8, toDisplayString(_ctx.translate("shape.square")), 1),
      createBaseVNode("quark-button", _hoisted_9, toDisplayString(_ctx.translate("shape.round")), 1)
    ]),
    ...
    createBaseVNode("div", _hoisted_13, [
      createBaseVNode("quark-button", _hoisted_14, toDisplayString(_ctx.translate("title.disabled")), 1),
    ...
    createBaseVNode("div", _hoisted_17, [
      createBaseVNode("quark-button", _hoisted_18, toDisplayString(_ctx.translate("loading")), 1),
      createBaseVNode("quark-button", _hoisted_19, toDisplayString(_ctx.translate("loading")), 1),
      createBaseVNode("quark-button", {
        onClick: _cache[0] || (_cache[0] = (...args) => _ctx.changeLoading && _ctx.changeLoading(...args)),
        loading: _ctx.isLoading,
        type: "success"
      }, toDisplayString(_ctx.translate("click")), 9, _hoisted_20)
    ]),
    createBaseVNode("h2", null, toDisplayString(_ctx.translate("title.icon")), 1),
    createBaseVNode("div", _hoisted_21, [
      createBaseVNode("quark-button", _hoisted_22, toDisplayString(_ctx.translate("like")), 1),
      createBaseVNode("quark-button", _hoisted_23, toDisplayString(_ctx.translate("name")), 1)
    ]),
    createBaseVNode("h2", null, toDisplayString(_ctx.translate("title.size")), 1),
    createBaseVNode("div", _hoisted_24, [
      createBaseVNode("quark-button", _hoisted_25, toDisplayString(_ctx.translate("size.big")), 1),
      createBaseVNode("quark-button", _hoisted_26, toDisplayString(_ctx.translate("size.normal")), 1),
      createBaseVNode("quark-button", _hoisted_27, toDisplayString(_ctx.translate("size.small")), 1)
    ])
  ]);
}
