import { m as f, n as r, w, s, q as h, v as d, x as a$1 } from "./mobile.5d914166.js";
function c(n) {
  var i = function() {
...
var a = function(t) {
  ...
  function r$1() {
    var t2;
    return r(this, r$1), (t2 = e.call(this)).attachShadow({
      mode: "open"
...
customElements.get("quark-icon-user") || customElements.define("quark-icon-user", a);
