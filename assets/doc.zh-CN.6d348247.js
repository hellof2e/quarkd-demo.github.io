import{d as a,c as n,a as l,o as t}from"./vue.9fde585d.js";const p={class:"markdown-body"},e=l(`<h1>ShareSheet</h1><h3>\u4ECB\u7ECD</h3><p>ShareSheet\u5206\u4EAB\u9762\u677F</p><h3>\u5B89\u88C5</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> ShareSheet <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;quarkd/lib/sharesheet&#39;</span>;
...
</code></pre>`,19),c=[e],d={},i="",j=a({__name:"doc.zh-CN",setup(h,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(r,o)=>(t(),n("div",p,c))}});export{j as default,i as excerpt,d as frontmatter};
