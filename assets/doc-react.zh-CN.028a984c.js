import{d as a,c as n,a as l,o as p}from"./vue.9fde585d.js";const t={class:"markdown-body"},c=l(`<h1>Form \u8868\u5355</h1><h3>\u4ECB\u7ECD</h3><p>\u8868\u5355</p><h3>\u5B89\u88C5\u4F7F\u7528</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Form,FormRef } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>
...
</code></pre>`,17),h=[c],o={},g="",i=a({__name:"doc-react.zh-CN",setup(e,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(u,j)=>(p(),n("div",t,h))}});export{i as default,g as excerpt,o as frontmatter};
