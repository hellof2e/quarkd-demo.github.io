import{d as a,c as t,a as n,o as l}from"./vue.c3d4c3bf.js";const e={class:"markdown-body"},c=n(`<h1>Tab</h1><h3>Introduce</h3><p>Used to switch between different content areas.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Tabs, TabContent } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
</code></pre><h3>Basic Usage</h3><pre><code class="language-tsx">&lt;Tabs activekey=<span class="hljs-string">&quot;{1}&quot;</span>&gt;
...
&lt;/Tabs&gt;
</code></pre><h3>Match By Name</h3><pre><code class="language-tsx">&lt;Tabs activekey={<span class="hljs-string">&quot;d&quot;</span>}&gt;
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">TabContent</span>&gt;</span></span>
&lt;/Tabs&gt;
</code></pre><h3>Swipe Tabs</h3><p>Horizontal scrolling is automatically supported when the length exceeds the viewport.</p><pre><code class="language-tsx">&lt;Tabs&gt;
...
</code></pre><h3>Sticky</h3><p>In sticky mode, the nav-item will be fixed to top when scroll to top.</p><pre><code class="language-tsx">&lt;Tabs sticky offsettop=<span class="hljs-string">&quot;17vw&quot;</span>&gt;
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">TabContent</span> <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;tab1&quot;</span>&gt;</span> tab1 content <span class="hljs-tag">&lt;/<span class="hljs-name">TabContent</span>&gt;</span></span>
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">TabContent</span> <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;tab2&quot;</span>&gt;</span> tab2 content <span class="hljs-tag">&lt;/<span class="hljs-name">TabContent</span>&gt;</span></span>
