import{d as n,c as a,a as e,o as t}from"./vue.335f97cb.js";const o={class:"markdown-body"},p=e(`<h1>Common Problem</h1><h2>Vue Precautions For Use</h2><p>Vue project using <code class="">quark</code> component may appear <strong>warning</strong>\uFF1A</p><pre><code class="language-html"><span class="hljs-comment">&lt;!-- vue@2.x: --&gt;</span>
...
</code></pre>`,8),c=[p],m={},h="",d=n({__name:"notice.en-US",setup(l,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(r,u)=>(t(),a("div",o,c))}});export{d as default,h as excerpt,m as frontmatter};
