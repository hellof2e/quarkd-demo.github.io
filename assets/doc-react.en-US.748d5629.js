import{d as a,c as n,a as t,o as l}from"./vue.fb1e851f.js";const p={class:"markdown-body"},e=t(`<h1>ImagePreview</h1><h3>Intro</h3><p>Basic image preview function</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> {
  imagepreview,
  ImagePreview,
  ImagePreviewRef,
...
</code></pre><h3>slot</h3><table><thead><tr><th>Name</th><th>Description</th></tr></thead><tbody><tr><td>name=indicator</td><td>Custom show pages</td></tr></tbody></table>`,29),c=[e],g={},j="",u=a({__name:"doc-react.en-US",setup(o,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(r,h)=>(l(),n("div",p,c))}});export{u as default,j as excerpt,g as frontmatter};
