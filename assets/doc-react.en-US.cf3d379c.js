import{d as s,c as a,a as e,o}from"./vue.c3d4c3bf.js";const l={class:"markdown-body"},n=e(`<h1>Tooltip</h1><h3>Intro</h3><p>Simple text prompt bubbles.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Tooltip } <span class="hljs-string">&#39;@quarkd/quark-react&#39;</span>;
  ...
  <span class="hljs-keyword">return</span> (
    <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Tooltip</span> <span class="hljs-attr">tips</span>=<span class="hljs-string">&quot;bubble text&quot;</span> <span class="hljs-attr">open</span>=<span class="hljs-string">{open}</span> <span class="hljs-attr">onClose</span>=<span class="hljs-string">{handleClose}</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">onClick</span>=<span class="hljs-string">{handleClick}</span>&gt;</span>top position<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">Tooltip</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
  );
};
</code></pre><h3>Set Tips Direction</h3><p>The tips position of the bubble is controlled by the placement property.</p><pre><code class="language-tsx">&lt;Tooltip placement=<span class="hljs-string">&quot;top&quot;</span> tips=<span class="hljs-string">&quot;bubble text&quot;</span>&gt;
...
</code></pre><h3>Show Close Button</h3><p>Control whether to display the close button through the closeable property.</p><pre><code class="language-tsx">&lt;Tooltip tips=<span class="hljs-string">&quot;bubble text&quot;</span> closeable&gt;
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>top position<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
&lt;/Tooltip&gt;
</code></pre><h3>Whether To Close Automatically</h3><p>Whether to automatically close is controlled by the autoclose property, and how many milliseconds it will be automatically closed by the opentime property.</p><pre><code class="language-tsx">&lt;Tooltip tips=<span class="hljs-string">&quot;bubble text&quot;</span> autoclose opentime=<span class="hljs-string">&quot;5000&quot;</span>&gt;
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>top position<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
&lt;/Tooltip&gt;
</code></pre><h3>Scroll To Close</h3><p>Controls whether to close when the page is scrolled through the scroolhidden property.</p><pre><code class="language-tsx">&lt;Tooltip tips=<span class="hljs-string">&quot;bubble text&quot;</span> scroolhidden&gt;
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>top position<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
&lt;/Tooltip&gt;
</code></pre><h3>Custom Style</h3><pre><code class="language-tsx">&lt;Tooltip tips=<span class="hljs-string">&quot;bubble text&quot;</span>&gt;
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>top position<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
&lt;/Tooltip&gt;
