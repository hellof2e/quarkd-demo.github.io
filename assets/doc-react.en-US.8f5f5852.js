...
</code></pre><h3>Shape</h3><p>Checkbox shape supports <code class="">round</code> and <code class="">square</code>, the default is <code class="">round</code>.</p><pre><code class="language-tsx">&lt;Checkbox checked={<span class="hljs-literal">true</span>}&gt;round(<span class="hljs-keyword">default</span>)&lt;/Checkbox&gt;
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Checkbox</span> <span class="hljs-attr">checked</span>=<span class="hljs-string">{true}</span> <span class="hljs-attr">shape</span>=<span class="hljs-string">&quot;square&quot;</span>&gt;</span>square<span class="hljs-tag">&lt;/<span class="hljs-name">Checkbox</span>&gt;</span></span>
</code></pre><h3>Size</h3><p>Checkbox size supports <code class="">normal</code> and <code class="">big</code>, the default is <code class="">normal</code>.</p><pre><code class="language-tsx">&lt;Checkbox checked={<span class="hljs-literal">true</span>} shape=<span class="hljs-string">&quot;round&quot;</span> size=<span class="hljs-string">&quot;big&quot;</span>
  &gt;<span class="hljs-keyword">default</span> shape - big&lt;/Checkbox
&gt;
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Checkbox</span> <span class="hljs-attr">checked</span>=<span class="hljs-string">{true}</span> <span class="hljs-attr">shape</span>=<span class="hljs-string">&quot;square&quot;</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;big&quot;</span>&gt;</span>square - big<span class="hljs-tag">&lt;/<span class="hljs-name">Checkbox</span>&gt;</span></span>
</code></pre><h3>Disabled</h3><p>To disable Checkbox, add <code class="">disabled</code> prop on the Checkbox.</p><pre><code class="language-tsx">&lt;Checkbox checked={<span class="hljs-literal">true</span>} disabled&gt;checked - disabled&lt;/Checkbox&gt;
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Checkbox</span> <span class="hljs-attr">checked</span>=<span class="hljs-string">{true}</span> <span class="hljs-attr">disabled</span>&gt;</span>unchecked - disabled<span class="hljs-tag">&lt;/<span class="hljs-name">Checkbox</span>&gt;</span></span>
