import{c as a,o as n,a as t}from"./vue.7909cb08.js";const l={class:"markdown-body"},p=t(`<h1>ShareSheet</h1><h3>\u4ECB\u7ECD</h3><p>ShareSheet\u5206\u4EAB\u9762\u677F</p><h3>\u5B89\u88C5</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { ShareSheet } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;@quarkd/quark-react&#39;</span>;
...
</code></pre>`,16),c=[p],i={__name:"doc-react.zh-CN",setup(e,{expose:s}){return s({frontmatter:{}}),(o,r)=>(n(),a("div",l,c))}};export{i as default};
