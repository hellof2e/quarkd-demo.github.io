import{d as a,c as n,a as l,o as p}from"./vue.75a97d5f.js";const t={class:"markdown-body"},e=l(`<h1>ImagePreview \u56FE\u7247\u9884\u89C8</h1><h3>\u4ECB\u7ECD</h3><p>\u63D0\u4F9B\u57FA\u7840\u56FE\u7247\u9884\u89C8\u529F\u80FD</p><h3>\u5B89\u88C5\u4F7F\u7528</h3><p>\u5176\u4E2D <code class="">imagepreview</code> \u4E3A\u51FD\u6570\u5F0F\u7528\u6CD5\u3001<code class="">ImagePreview</code> \u4E3A\u7EC4\u4EF6\u5F0F\u7528\u6CD5</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { imagepreview, ImagePreview, ImagePreviewRef} <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
  ...
  <span class="hljs-keyword">return</span> (
      <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
        ...
        <span class="hljs-tag">&lt;<span class="hljs-name">ImagePreview</span> <span class="hljs-attr">ref</span>=<span class="hljs-string">{preview2}</span> <span class="hljs-attr">open</span>=<span class="hljs-string">{open}</span>&gt;</span>
          <span class="hljs-tag">&lt;<span class="hljs-name">p</span> <span class="hljs-attr">className</span>=<span class="hljs-string">&quot;my-indicator&quot;</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">&quot;indicator&quot;</span>&gt;</span>Page{{ index }} <span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
...
</code></pre><h3>slot</h3><table><thead><tr><th>\u540D\u79F0</th><th>\u8BF4\u660E</th></tr></thead><tbody><tr><td>name=indicator</td><td>\u81EA\u5B9A\u4E49\u5206\u9875\u663E\u793A</td></tr></tbody></table>`,29),u=[e],i={},g="",j=a({__name:"doc-react.zh-CN",setup(c,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(h,r)=>(p(),n("div",t,u))}});export{j as default,g as excerpt,i as frontmatter};
