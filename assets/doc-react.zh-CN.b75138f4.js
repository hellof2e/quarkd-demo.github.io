import{d as a,c as t,a as l,o as n}from"./vue.c3d4c3bf.js";const u={class:"markdown-body"},e=l(`<h1>Field \u8F93\u5165\u7EC4\u4EF6</h1><h3>\u4ECB\u7ECD</h3><p>\u8F93\u5165\u7EC4\u4EF6</p><h3>\u5B89\u88C5\u4F7F\u7528</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Field, FieldRef } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
</code></pre><h3>\u57FA\u7840\u7528\u6CD5</h3><pre><code class="language-tsx">&lt;Field placeholder=<span class="hljs-string">&quot;\u8BF7\u8F93\u5165\u6587\u672C&quot;</span> label=<span class="hljs-string">&quot;\u6587\u672C&quot;</span> /&gt;
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Field</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;password&quot;</span> <span class="hljs-attr">value</span>=<span class="hljs-string">&quot;123456&quot;</span> <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;\u5BC6\u7801&quot;</span> /&gt;</span></span>
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Field</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;number&quot;</span> <span class="hljs-attr">value</span>=<span class="hljs-string">&quot;12345678901&quot;</span> <span class="hljs-attr">max</span>=<span class="hljs-string">&quot;11&quot;</span> <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;\u6570\u5B57&quot;</span> /&gt;</span></span>
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Field</span> <span class="hljs-attr">value</span>=<span class="hljs-string">&quot;\u4E00\u4E8C\u4E09\u56DB\u4E94&quot;</span> <span class="hljs-attr">maxlength</span>=<span class="hljs-string">&quot;5&quot;</span> <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;\u6700\u591A5\u4F4D\u6570&quot;</span> /&gt;</span></span>
</code></pre><h3>\u81EA\u5B9A\u4E49\u6807\u9898/\u65E0\u6807\u9898</h3><pre><code class="language-tsx">&lt;Field value=<span class="hljs-string">&quot;\u81EA\u5B9A\u4E49\u6807\u9898&quot;</span>&gt;
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">&quot;label&quot;</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;label&quot;</span>&gt;</span>
...
&lt;/Field&gt;
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Field</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">&quot;\u7981\u7528label&quot;</span> <span class="hljs-attr">value</span>=<span class="hljs-string">&quot;\u65E0\u6807\u9898&quot;</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;oneLine&quot;</span> /&gt;</span></span>
</code></pre><h3>\u7981\u7528\u4E0E\u53EA\u8BFB</h3><pre><code class="language-tsx">&lt;Field value=<span class="hljs-string">&quot;\u6211\u7981\u7528\u4E86&quot;</span> label=<span class="hljs-string">&quot;\u7981\u7528&quot;</span> disabled /&gt;
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Field</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">&quot;\u7981\u7528label&quot;</span> /&gt;</span></span>
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Field</span> <span class="hljs-attr">value</span>=<span class="hljs-string">&quot;\u6211\u662F\u53EA\u8BFB\u7684&quot;</span> <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;\u53EA\u8BFB&quot;</span> <span class="hljs-attr">readonly</span> /&gt;</span></span>
</code></pre><h3>\u8BBE\u7F6E\u5FC5\u586B\u5B57\u6BB5</h3><pre><code class="language-tsx">&lt;Field placeholder=<span class="hljs-string">&quot;\u8BF7\u8F93\u5165&quot;</span> label=<span class="hljs-string">&quot;\u6587\u672C&quot;</span> required errormsg=<span class="hljs-string">&quot;\u4E0D\u80FD\u4E3A\u7A7A&quot;</span> /&gt;
</code></pre><h3>css \u5C5E\u6027</h3><pre><code class="language-tsx">&lt;Field <span class="hljs-class"><span class="hljs-keyword">class</span></span>=<span class="hljs-string">&quot;theme&quot;</span> value=<span class="hljs-string">&quot;css \u5C5E\u6027&quot;</span> label=<span class="hljs-string">&quot;css&quot;</span> /&gt;
...
</code></pre><h2>\u6837\u5F0F\u53D8\u91CF</h2><p>\u7EC4\u4EF6\u63D0\u4F9B\u4E86\u4EE5\u4E0B<a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/Using_CSS_custom_properties">CSS \u53D8\u91CF</a>\uFF0C\u53EF\u7528\u4E8E\u81EA\u5B9A\u4E49\u6837\u5F0F\uFF0C\u4F7F\u7528\u65B9\u6CD5\u8BF7\u53C2\u8003<a href="#/theme">\u4E3B\u9898\u5B9A\u5236</a>\u3002</p><table><thead><tr><th>\u540D\u79F0</th><th>\u8BF4\u660E</th><th>\u9ED8\u8BA4\u503C</th></tr></thead><tbody><tr><td><code class="">--field-label-width</code></td><td>label \u5BBD\u5EA6</td><td><code class="">119px</code></td></tr><tr><td><code class="">--field-label-font-size</code></td><td>label \u5B57\u4F53\u5927\u5C0F</td><td><code class="">15px</code></td></tr><tr><td><code class="">--field-label-text-color</code></td><td>label \u5B57\u4F53\u989C\u8272</td><td><code class="">#242729</code></td></tr><tr><td><code class="">--field-label-font-weight</code></td><td>label \u5B57\u91CD</td><td></td></tr><tr><td><code class="">--field-label-margin-right</code></td><td>label \u53F3\u95F4\u8DDD</td><td><code class="">12px</code></td></tr><tr><td><code class="">--field-input-text-color</code></td><td>input \u5B57\u4F53\u989C\u8272</td><td><code class="">#242729</code></td></tr><tr><td><code class="">--field-input-align</code></td><td>input \u5BF9\u9F50\u65B9\u5F0F</td><td><code class="">left</code></td></tr><tr><td><code class="">--field-input-font-size</code></td><td>input \u5B57\u4F53\u5927\u5C0F</td><td><code class="">15px</code></td></tr><tr><td><code class="">--field-placeholder-text-color</code></td><td>input \u63D0\u793A\u5B57\u4F53\u989C\u8272</td><td><code class="">#bcc4cc</code></td></tr><tr><td><code class="">--field-placeholder-font-size</code></td><td>input \u63D0\u793A\u5B57\u4F53\u5927\u5C0F</td><td><code class="">15px</code></td></tr><tr><td><code class="">--field-disabled-text-color</code></td><td>\u7981\u6B62\u5B57\u4F53\u989C\u8272</td><td><code class="">#c8c9cc</code></td></tr><tr><td><code class="">--field-error-font-size</code></td><td>\u9519\u8BEF\u63D0\u793A\u5B57\u4F53\u5927\u5C0F</td><td><code class="">12px</code></td></tr><tr><td><code class="">--field-error-text-color</code></td><td>\u9519\u8BEF\u63D0\u793A\u5B57\u4F53\u989C\u8272</td><td><code class="">#F72626</code></td></tr><tr><td><code class="">--field-error-text-align</code></td><td>\u9519\u8BEF\u63D0\u793A\u5B57\u4F53\u5BF9\u9F50\u65B9\u5F0F</td><td><code class="">left</code></td></tr></tbody></table>`,30),d=[e],h={},i="",j=a({__name:"doc-react.zh-CN",setup(c,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(p,o)=>(n(),t("div",u,d))}});export{j as default,i as excerpt,h as frontmatter};
