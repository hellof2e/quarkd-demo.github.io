import{c as a,o as t,a as n}from"./vue.5185afba.js";const l={class:"markdown-body"},e=n(`<h1>PullRefresh</h1><h3>Introduce</h3><p>Used to provide interactive operations for pull-down refresh.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { PullRefresh } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
...
<span class="hljs-tag">&lt;/<span class="hljs-name">PullRefresh</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">className</span>=<span class="hljs-string">&quot;refresh-text&quot;</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">&quot;pulling&quot;</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">img</span> <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;https://m.hellobike.com/resource/helloyun/18625/3OOq2_down.svg&quot;</span> /&gt;</span>drop down prompt
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">className</span>=<span class="hljs-string">&quot;refresh-text&quot;</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">&quot;loosing&quot;</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">img</span> <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;https://m.hellobike.com/resource/helloyun/18625/ImS4S_up.svg&quot;</span> /&gt;</span>Release to refresh now
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">PullRefresh</span>&gt;</span>
</code></pre><h2>API</h2><h3>Props</h3><table><thead><tr><th>Attribute</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td>dark</td><td>Dark mode (background value: #0088FF )</td><td><code>boolean</code></td><td><code>false</code></td></tr><tr><td>disabled</td><td>Whether to disable</td><td><code>boolean</code></td><td><code>false</code></td></tr><tr><td>headheight</td><td>Top content height / distance to trigger pull-down refresh</td><td><code>string/number</code></td><td><code>96</code></td></tr><tr><td>loading</td><td>Is it in loading state</td><td><code>boolean</code></td><td><code>false</code></td></tr><tr><td>pullingtext</td><td>Pulling text</td><td><code>string</code></td><td><code>Pull to refresh</code></td></tr><tr><td>loosingtext</td><td>Loosing text</td><td><code>string</code></td><td><code>Loose to refresh</code></td></tr><tr><td>loadingtext</td><td>Loading text</td><td><code>string</code></td><td><code>Loading...</code></td></tr><tr><td>textcolor</td><td>Text color</td><td><code>string</code></td><td><code>#879099</code></td></tr><tr><td>onRefresh</td><td>Emitted after pulling refresh</td><td><code>() =&gt; void</code></td><td></td></tr></tbody></table><h3>slots</h3><table><thead><tr><th>Name</th><th>Description</th></tr></thead><tbody><tr><td>content</td><td>Content to show</td></tr><tr><td>pulling</td><td>Content of head when at pulling</td></tr><tr><td>loosing</td><td>Content of head when at loosing</td></tr><tr><td>loading</td><td>Content of head when at loading</td></tr></tbody></table>`,18),p=[e],g={__name:"doc-react.en-US",setup(o,{expose:s}){return s({frontmatter:{}}),(d,r)=>(t(),a("div",l,p))}};export{g as default};
