import{d as t,c as a,a as l,o as n}from"./vue.41a5ff19.js";const e={class:"markdown-body"},d=l(`<h1>Field</h1><h3>Intro</h3><p>Input Component</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Field, FieldRef } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
</code></pre><h3>Basic Usage</h3><pre><code class="language-tsx">&lt;Field placeholder=<span class="hljs-string">&quot;Please enter text&quot;</span> label=<span class="hljs-string">&quot;label&quot;</span> /&gt;
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Field</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;password&quot;</span> <span class="hljs-attr">value</span>=<span class="hljs-string">&quot;123456&quot;</span> <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;password&quot;</span> /&gt;</span></span>
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Field</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;number&quot;</span> <span class="hljs-attr">value</span>=<span class="hljs-string">&quot;12345678901&quot;</span> <span class="hljs-attr">max</span>=<span class="hljs-string">&quot;11&quot;</span> <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;number&quot;</span> /&gt;</span></span>
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Field</span> <span class="hljs-attr">value</span>=<span class="hljs-string">&quot;12345&quot;</span> <span class="hljs-attr">maxlength</span>=<span class="hljs-string">&quot;5&quot;</span> <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;up to 5 digits&quot;</span> /&gt;</span></span>
</code></pre><h3>Custom Label</h3><pre><code class="language-tsx">&lt;Field value=<span class="hljs-string">&quot;custom label&quot;</span>&gt;
...
&lt;/Field&gt;
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Field</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">&quot;disable label&quot;</span> <span class="hljs-attr">value</span>=<span class="hljs-string">&quot;no label&quot;</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;oneLine&quot;</span> /&gt;</span></span>
</code></pre><h3>Disabled &amp; Readonly</h3><pre><code class="language-tsx">&lt;Field value=<span class="hljs-string">&quot;be disabled&quot;</span> label=<span class="hljs-string">&quot;disabled&quot;</span> disabled /&gt;
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Field</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">&quot;disable label&quot;</span> /&gt;</span></span>
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Field</span> <span class="hljs-attr">value</span>=<span class="hljs-string">&quot;be readonly&quot;</span> <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;readonly&quot;</span> <span class="hljs-attr">readonly</span> /&gt;</span></span>
</code></pre><h3>Required Fields</h3><pre><code class="language-tsx">&lt;Field
  placeholder=<span class="hljs-string">&quot;Please enter text&quot;</span>
  label=<span class="hljs-string">&quot;label&quot;</span>
  required
  errormsg=<span class="hljs-string">&quot;can not be empty&quot;</span>
/&gt;
</code></pre><h3>CSS Style</h3><pre><code class="language-tsx">&lt;Field <span class="hljs-class"><span class="hljs-keyword">class</span></span>=<span class="hljs-string">&quot;theme&quot;</span> value=<span class="hljs-string">&quot;css style&quot;</span> label=<span class="hljs-string">&quot;css&quot;</span> /&gt;
