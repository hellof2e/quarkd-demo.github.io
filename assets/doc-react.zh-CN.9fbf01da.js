import{c as a,o as n,a as l}from"./vue.5ce4fb01.js";const p={class:"markdown-body"},t=l(`<h1>Form \u8868\u5355</h1><h3>\u4ECB\u7ECD</h3><p>\u8868\u5355</p><h3>\u5B89\u88C5\u4F7F\u7528</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Form,FormRef } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>
...
</code></pre><h3>\u81EA\u5B9A\u4E49\u6821\u9A8C\u89C4\u5219</h3><p>\u53EA\u5BF9 field \u7EC4\u4EF6\u6709\u7528\uFF0C\u652F\u6301 required \u3001validator\u81EA\u5B9A\u4E49\u4E8B\u4EF6</p><pre><code class="language-tsx">  <span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> () =&gt; {
    ...
    <span class="hljs-keyword">return</span> (
      <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">From</span> <span class="hljs-attr">ref</span>=<span class="hljs-string">{form2}</span>&gt;</span>
        ...
        <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;submit-wrap&quot;</span>&gt;</span>
          <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">onClick</span>=<span class="hljs-string">&quot;submit2&quot;</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;submit&quot;</span>&gt;</span>\u63D0\u4EA4<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
        <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
...
</code></pre><h3>\u65B9\u6CD5</h3><table><thead><tr><th>\u540D\u79F0</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th></tr></thead><tbody><tr><td>submit</td><td>\u63D0\u4EA4\u5E76\u6821\u9A8C\u8868\u5355\u83B7\u53D6\u6240\u6709\u7EC4\u4EF6\u7684 value</td><td><code>() =&gt; Promise&lt;any[]&gt;</code></td></tr><tr><td>setRules</td><td>\u53EA\u5BF9 field \u7EC4\u4EF6\u6709\u6548</td><td><code>(rule: Rule[])=&gt;void</code></td></tr></tbody></table><h3>\u7C7B\u578B\u5B9A\u4E49</h3><pre><code class="language-js">type Rule = {
...
</code></pre>`,17),c=[t],g={__name:"doc-react.zh-CN",setup(h,{expose:s}){return s({frontmatter:{}}),(j,r)=>(n(),a("div",p,c))}};export{g as default};
