import{d as e,c as t,a,o as d}from"./vue.41a5ff19.js";const l={class:"markdown-body"},o=a(`<h1>Uploader</h1><h3>Intro</h3><p>Provide upload function</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Uploader, UploaderRef } <span class="hljs-string">&quot;quark-react&quot;</span>;
...
</code></pre><h3>Max Count</h3><p>Hide redundant and upload button when the number of uploaded files is more than max count.</p><pre><code class="language-tsx">&lt;Uploader maxcount=<span class="hljs-string">&quot;2&quot;</span> preview /&gt;
...
</code></pre><h3>Custom Upload Area</h3><pre><code class="language-tsx">&lt;Uploader&gt;
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">&quot;uploader&quot;</span>&gt;</span>Upload files<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
&lt;/Uploader&gt;
