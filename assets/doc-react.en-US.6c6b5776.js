import{d as a,c as t,a as n,o as l}from"./vue.5e10e00c.js";const e={class:"markdown-body"},p=n(`<h1>Popover</h1><h3>Intro</h3><p>Used to display some content on top of another.</p><h3>Install</h3><pre><code class="language-jsx"><span class="hljs-keyword">import</span> { Popover, PopoverRef } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
