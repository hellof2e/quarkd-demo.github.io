import{d as a,c as t,a as n,o as l}from"./vue.41a5ff19.js";const e={class:"markdown-body"},o=n(`<h1>Popover</h1><h3>Intro</h3><p>Used to display some content on top of another.</p><h3>Install</h3><pre><code class="language-jsx"><span class="hljs-keyword">import</span> { Popover, PopoverRef } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
...
</code></pre><h3>Light Style</h3><p>Popover supports light and dark styles. The default is dark style. Set the theme property to light to switch to light style.</p><pre><code class="language-tsx">&lt;Popover theme=<span class="hljs-string">&quot;light&quot;</span>&gt;
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;Popover&quot;</span> @<span class="hljs-attr">click</span>=<span class="hljs-string">&quot;click&quot;</span>&gt;</span>Light Style<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
&lt;/Popover&gt;
...
</code></pre><h3>Position</h3><p>The pop-up position of the bubble is controlled by the placement property.</p><pre><code class="language-tsx">&lt;Popover placement=<span class="hljs-string">&quot;top&quot;</span>&gt;
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;Popover&quot;</span>&gt;</span>Light Style<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
&lt;/Popover&gt;
...
</code></pre><h3>Custom Content</h3><p>With the content slot, arbitrary content can be placed inside the Popover.</p><pre><code class="language-tsx">&lt;Popover&gt;
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;Popover&quot;</span>&gt;</span>Custom Style<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">&quot;content&quot;</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;popover-content&quot;</span>&gt;</span>This is custom content<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
&lt;/Popover&gt;
...
</code></pre><h3>Close Scroll</h3><p>The scrollhidden property controls whether to close when the page is scrolled.</p><pre><code class="language-tsx">&lt;Popover scroolhidden&gt;
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;Popover&quot;</span>&gt;</span>Close Scroll<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
&lt;/Popover&gt;
