import{d as a,c as n,a as l,o as p}from"./vue.90d6f6a1.js";const t={class:"markdown-body"},c=l(`<h1>Form</h1><h3>Intro</h3><p>Form</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Form, FormRef } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>
...
</code></pre>`,17),e=[c],g={},i="",u=a({__name:"doc-react.en-US",setup(h,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(r,j)=>(p(),n("div",t,e))}});export{u as default,i as excerpt,g as frontmatter};
