import{d as a,c as t,a as n,o as l}from"./vue.b26122a1.js";const e={class:"markdown-body"},p=n(`<h1>PullRefresh</h1><h3>Introduce</h3><p>Used to provide interactive operations for pull-down refresh.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { PullRefresh } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
