import{d as e,c as s,a,o as d}from"./vue.41a5ff19.js";const o={class:"markdown-body"},n=a(`<h1>Textarea</h1><h3>Intro</h3><p>Multi-line text input</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Textarea } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
</code></pre><h3>Basic Usage</h3><pre><code class="language-tsx">&lt;Textarea /&gt;
</code></pre><h3>Rows Number</h3><pre><code class="language-tsx">&lt;Textarea rows=<span class="hljs-string">&quot;6&quot;</span> /&gt;
</code></pre><h3>Autosize</h3><pre><code class="language-tsx">&lt;Textarea autosize /&gt;
</code></pre><h3>Count</h3><pre><code class="language-tsx">&lt;Textarea showcount /&gt;
</code></pre><h3>Maxlength</h3><pre><code class="language-tsx">&lt;Textarea showcount maxlength=<span class="hljs-string">&quot;50&quot;</span> /&gt;
</code></pre><h3>Disabled</h3><pre><code class="language-tsx">&lt;Textarea disabled /&gt;
</code></pre><h3>Custom Style</h3><pre><code class="language-tsx">&lt;Textarea showcount <span class="hljs-class"><span class="hljs-keyword">class</span></span>=<span class="hljs-string">&quot;custom-style&quot;</span> /&gt;
