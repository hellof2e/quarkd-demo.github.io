import{c as a,o as n,a as l}from"./vue.0277ddec.js";const t={class:"markdown-body"},p=l(`<h1>Quick Start</h1><h2>Preview</h2><blockquote><p>Scan the QR code below to experience the Quark component library example</p></blockquote><img src="https://m.hellobike.com/resource/helloyun/16682/76s6X_quark.demo.png?x-oss-process=image/quality,q_80" width="200" alt="qr.png"><h2>NPM Install</h2><pre><code class="language-shell"><span class="hljs-meta">#</span><span class="bash"> Vue project</span>
npm i quark
...
</code></pre><h2>2. Example React</h2><pre><code class="language-jsx"><span class="hljs-keyword">import</span> { Button } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quark-react&quot;</span>;
...
</code></pre>`,13),e=[p],u={__name:"quickstart.en-US",setup(c,{expose:s}){return s({frontmatter:{}}),(r,h)=>(n(),a("div",t,e))}};export{u as default};
