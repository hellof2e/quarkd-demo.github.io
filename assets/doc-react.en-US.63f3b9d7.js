import{c as a,o as t,a as n}from"./vue.f3489915.js";const l={class:"markdown-body"},e=n(`<h1>Tab</h1><h3>Introduce</h3><p>Used to switch between different content areas.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Tabs, TabContent } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;@quarkd/quark-react&#39;</span>;
