import{d as a,c as n,a as t,o as l}from"./vue.14be8519.js";const p={class:"markdown-body"},e=t(`<h1>ImagePreview</h1><h3>Intro</h3><p>Basic image preview function</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { imagepreview, ImagePreview, ImagePreviewRef} <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
...
</code></pre><h3>slot</h3><table><thead><tr><th>Name</th><th>Description</th></tr></thead><tbody><tr><td>name=indicator</td><td>Custom show pages</td></tr></tbody></table>`,29),c=[e],g={},j="",d=a({__name:"doc-react.en-US",setup(r,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(h,o)=>(l(),n("div",p,c))}});export{d as default,j as excerpt,g as frontmatter};
