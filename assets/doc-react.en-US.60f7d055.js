import{d as t,c as a,a as n,o as e}from"./vue.c3d4c3bf.js";const l={class:"markdown-body"},p=n(`<h1>Steps</h1><h3>Intro</h3><p>Split the process into multiple steps and display them, so that you can complete tasks through the process. Besides, the steps will show you the current status of work.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Steps, StepItem } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
</code></pre><h3>Basic Usage</h3><pre><code class="language-tsx">&lt;Steps&gt;
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">StepItem</span> <span class="hljs-attr">status</span>=<span class="hljs-string">&quot;done&quot;</span> <span class="hljs-attr">title</span>=<span class="hljs-string">&quot;step one&quot;</span> <span class="hljs-attr">order</span>=<span class="hljs-string">&quot;1&quot;</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">StepItem</span>&gt;</span></span>
...
&lt;/Steps&gt;
</code></pre><h3>Title &amp; Content</h3><pre><code class="language-tsx">&lt;Steps&gt;
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">StepItem</span>&gt;</span></span>
&lt;/Steps&gt;
</code></pre><h3>Vertical Steps</h3><pre><code class="language-tsx">&lt;Steps direction=<span class="hljs-string">&quot;vertical&quot;</span>&gt;
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">StepItem</span>
    <span class="hljs-attr">status</span>=<span class="hljs-string">&quot;done&quot;</span>
    <span class="hljs-attr">title</span>=<span class="hljs-string">&quot;finished&quot;</span>
    <span class="hljs-attr">order</span>=<span class="hljs-string">&quot;1&quot;</span>
