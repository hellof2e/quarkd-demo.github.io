import{c as a,o as t,a as n}from"./vue.0277ddec.js";const l={class:"markdown-body"},e=n(`<h1>Internationalization</h1><h2>Intro</h2><p>Quark uses Chinese as the default language and supports multi-language switching. Please follow the tutorial below to set internationalization.</p><h2>Multi-language switch</h2><p>Quark implements multi-language support through the Locale component, and you can use the Locale.use method to switch the currently used language.</p><pre><code class="language-ts"><span class="hljs-keyword">import</span> Locale <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quark/lib/locale&quot;</span>;
<span class="hljs-comment">// import Chinese locale</span>
<span class="hljs-keyword">import</span> zhCN <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quark/lib/locale/lang/zh-CN&quot;</span>;

Locale.use(zhCN);
</code></pre><h2>Override language packs</h2><p>The Locale.add method can be used to modify the text. Examples are as follows:</p><pre><code class="language-ts"><span class="hljs-keyword">import</span> Locale <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quark/lib/locale&quot;</span>;
...
</code></pre><h2>How to internationalize business code?</h2><p>This can be done using <code>i18n</code>.</p>`,18),o=[e],d={__name:"internationalization.en-US",setup(r,{expose:s}){return s({frontmatter:{}}),(c,h)=>(t(),a("div",l,o))}};export{d as default};
