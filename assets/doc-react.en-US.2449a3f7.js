import{d as a,c as t,a as n,o as l}from"./vue.c3d4c3bf.js";const e={class:"markdown-body"},p=n(`<h1>Radio</h1><h3>Intro</h3><p>Single radio, Single selection among multiple options.</p><h2>Install</h2><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Radio } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> () =&gt; {
...
</code></pre><h3>Size</h3><p>Radio size supports <code class="">normal</code> and <code class="">big</code>, the default is <code class="">normal</code>.</p><pre><code class="language-tsx">&lt;RadioGroup value=<span class="hljs-string">&quot;{value}&quot;</span>&gt;
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">Radio</span>&gt;</span></span>
&lt;/RadioGroup&gt;
</code></pre><h3>Disabled</h3><p>To disable radio, add <code class="">disabled</code> prop on the Radio.</p><pre><code class="language-tsx">&lt;Radio checked={<span class="hljs-literal">true</span>} disabled&gt;checked - disabled&lt;/Radio&gt;
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">Radio</span> <span class="hljs-attr">checked</span>=<span class="hljs-string">{false}</span> <span class="hljs-attr">disabled</span>&gt;</span>unchecked - disabled<span class="hljs-tag">&lt;/<span class="hljs-name">Radio</span>&gt;</span></span>
