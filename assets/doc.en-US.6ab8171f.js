import{c as a,o as n,a as l}from"./vue.73a18cf8.js";const t={class:"markdown-body"},p=l(`<h1>List</h1><h3>Intro</h3><p>A list component to show items and control loading status.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> <span class="hljs-string">&quot;quarkd/lib/list&quot;</span>;
...
&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;list-text&quot;</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">&quot;loading&quot;</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">quark-loading</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;15&quot;</span>&gt;</span> Custom loading<span class="hljs-tag">&lt;/<span class="hljs-name">quark-loading</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">quark-list</span>&gt;</span>
</code></pre><h3>PullRefresh</h3><p>Can be used with <code>pull-refresh</code> component.</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> <span class="hljs-string">&quot;quarkd/lib/pull-refresh&quot;</span>;
...
</code></pre><h2>API</h2><h3>Props</h3><table><thead><tr><th>Arribute</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td>error</td><td>Whether loading is error, the load event will be Emitted only when error text clicked</td><td><code>boolean</code></td><td><code>false</code></td></tr><tr><td>loading</td><td>Whether to show loading info, the load event will not be Emitted when loading</td><td><code>boolean</code></td><td><code>false</code></td></tr><tr><td>finished</td><td>Whether loading is finished</td><td>boolean</td><td><code>false</code></td></tr><tr><td>offset</td><td>The load event will be Emitted when the distance between the scrollbar and the bottom is less than offset</td><td><code>number</code></td><td><code>300</code></td></tr><tr><td>loadingtext</td><td>Loading text</td><td><code>string</code></td><td><code>loading...</code></td></tr><tr><td>finishedtext</td><td>Finished text</td><td><code>string</code></td><td></td></tr><tr><td>errortext</td><td>Error loaded text</td><td><code>string</code></td><td></td></tr><tr><td>textcolor</td><td>Text font color</td><td><code>string</code></td><td><code>#879099</code></td></tr></tbody></table><h3>Event</h3><table><thead><tr><th>Event</th><th>Description</th><th>Type</th></tr></thead><tbody><tr><td>load</td><td>Emitted when the distance between the scrollbar and the bottom is less than offset</td><td><code>() =&gt; void</code></td></tr><tr><td>reload</td><td>Emitted when click retry after loading is error</td><td><code>() =&gt; void</code></td></tr></tbody></table><h3>slots</h3><table><thead><tr><th>Name</th><th>Description</th></tr></thead><tbody><tr><td>content</td><td>List content</td></tr><tr><td>finished</td><td>Custom finished tips</td></tr><tr><td>error</td><td>Custom error tips</td></tr><tr><td>loading</td><td>Custom loading tips</td></tr></tbody></table>`,26),e=[p],d={__name:"doc.en-US",setup(h,{expose:s}){return s({frontmatter:{}}),(i,r)=>(n(),a("div",t,e))}};export{d as default};
