import{d as a,c as n,a as t,o as l}from"./vue.93d13378.js";const p={class:"markdown-body"},c=t(`<h1>ShareSheet</h1><h3>Intro</h3><p>ShareSheet</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { ShareSheet } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;@quarkd/quark-react&#39;</span>;
...
</code></pre>`,16),e=[c],d={},j="",g=a({__name:"doc-react.en-US",setup(o,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(h,r)=>(l(),n("div",p,e))}});export{g as default,j as excerpt,d as frontmatter};
