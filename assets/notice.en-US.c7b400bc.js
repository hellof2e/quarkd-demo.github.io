import{c as n,o as e,a}from"./vue.81f12a40.js";const t={class:"markdown-body"},o=a(`<h1>Common Problem</h1><h2>Vue Precautions For Use</h2><p>Vue project using <code>quark</code> component may appear <strong>warning</strong>\uFF1A</p><pre><code class="language-html"><span class="hljs-comment">&lt;!-- vue@2.x: --&gt;</span>
...
</code></pre><h2>React+TS</h2><p>React+TS project using <code>quark</code> component may appear <strong>warning</strong>\uFF1A</p><pre><code>Property xx does not exist on type &#39;JSX.IntrinsicElements&#39;
</code></pre><p>This is due to the custom label, in order to avoid this warning, you can set the label type.</p><pre><code>declare namespace JSX {
  interface IntrinsicElements {
    [tag: string]: any;
  }
}
</code></pre>`,13),p=[o],m={__name:"notice.en-US",setup(c,{expose:s}){return s({frontmatter:{}}),(l,i)=>(e(),n("div",t,p))}};export{m as default};
