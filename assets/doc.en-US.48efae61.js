import{c as a,o as n,a as t}from"./vue.7987883a.js";const l={class:"markdown-body"},p=t(`<h1>ShareSheet</h1><h3>Intro</h3><p>ShareSheet</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> ShareSheet <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;quarkd/lib/sharesheet&#39;</span>;
...
</code></pre>`,19),e=[p],d={__name:"doc.en-US",setup(c,{expose:s}){return s({frontmatter:{}}),(o,r)=>(n(),a("div",l,e))}};export{d as default};
