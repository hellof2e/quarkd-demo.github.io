import{c as a,o as n,a as t}from"./vue.60af942b.js";const l={class:"markdown-body"},p=t(`<h1>Popover</h1><h3>Intro</h3><p>Used to display some content on top of another.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> <span class="hljs-string">&#39;quarkd/lib/popover&#39;</span>;
...
&lt;/script&gt;
</code></pre><h3>Light Style</h3><p>Popover supports light and dark styles. The default is dark style. Set the theme property to light to switch to light style.</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">quark-popover</span> <span class="hljs-attr">theme</span>=<span class="hljs-string">&quot;light&quot;</span> <span class="hljs-attr">ref</span>=<span class="hljs-string">&quot;popoverRef&quot;</span> <span class="hljs-attr">:open</span>=<span class="hljs-string">&quot;open&quot;</span> @<span class="hljs-attr">close</span>=<span class="hljs-string">&quot;close&quot;</span> @<span class="hljs-attr">select</span>=<span class="hljs-string">&quot;select&quot;</span>&gt;</span>
...
&lt;/script&gt;
</code></pre><h3>Close Scroll</h3><p>The scrollhidden property controls whether to close when the page is scrolled.</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">quark-popover</span> <span class="hljs-attr">scroolhidden</span> <span class="hljs-attr">ref</span>=<span class="hljs-string">&quot;popoverRef&quot;</span> <span class="hljs-attr">:open</span>=<span class="hljs-string">&quot;open&quot;</span> @<span class="hljs-attr">close</span>=<span class="hljs-string">&quot;close&quot;</span> @<span class="hljs-attr">select</span>=<span class="hljs-string">&quot;select&quot;</span>&gt;</span>
...
&lt;/script&gt;
</code></pre><h2>API</h2><h3>Props</h3><table><thead><tr><th>Attribute</th><th>Description</th><th>Type</th><th>Default Value</th></tr></thead><tbody><tr><td>open</td><td>Whether to show popover</td><td><code>boolean</code></td><td><code>false</code></td></tr><tr><td>placement</td><td>tip popup position</td><td><code>top</code> <code>topleft</code> <code>topright</code> <code>left</code> <code>lefttop</code> <code>leftbottom</code> <code>right</code> <code>righttop</code> <code>rightbottom</code> <code>bottom</code> <code>bottomleft</code> <code>bottomright</code></td><td><code>bottom</code></td></tr><tr><td>scroolhidden</td><td>Whether to close automatically when the page is scrolled</td><td><code>boolean</code></td><td><code>false</code></td></tr><tr><td>zindex</td><td>popover z-index</td><td><code>number</code></td><td><code>999</code></td></tr><tr><td>theme</td><td>popover theme mode</td><td>support <code>light</code> <code>dark</code></td><td><code>dark</code></td></tr></tbody></table><h3>Events</h3><table><thead><tr><th>Event</th><th>Description</th><th>Type</th></tr></thead><tbody><tr><td>close</td><td>Emitted when an action is closed</td><td><code>() =&gt; void</code></td></tr><tr><td>select</td><td>Emitted when an action is clicked</td><td><code>(e:{detail:{action: PopoverAction, index: number}}) =&gt; void</code></td></tr></tbody></table><h3>Methods</h3><table><thead><tr><th>Method</th><th>Description</th><th>Callback</th></tr></thead><tbody><tr><td>setActions</td><td>Used to set Popover options</td><td><code>(actions: PopoverAction[]) =&gt; void</code></td></tr></tbody></table><h3>Data Structure of PopoverAction</h3><pre><code class="language-js">type PopoverAction = {
  <span class="hljs-attr">text</span>: string;
  icon?: string; <span class="hljs-comment">// url link</span>
  disabled?: boolean;
};
</code></pre><h2>CSS Variables</h2><p>The component provides the following<a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/Using_CSS_custom_properties">CSS variables</a>,which can be used to customize styles.Please refer to <a href="#/zh-CN/guide/theme">Theme customization</a>\u3002</p><table><thead><tr><th>Name</th><th>Description</th><th>Default Value</th></tr></thead><tbody><tr><td><code>--popover-background-color</code></td><td>popover background-color</td><td><code>#4a4a4a</code></td></tr><tr><td><code>--popover-color</code></td><td>popover font-color</td><td><code>#fff</code></td></tr><tr><td><code>--popover-action-font-size</code></td><td>popover font-size</td><td><code>14px</code></td></tr><tr><td><code>--popover-action-font-weight</code></td><td>popover font-weight</td><td><code>400</code></td></tr><tr><td><code>--popover-action-line-height</code></td><td>popover line-height</td><td><code>1.4</code></td></tr><tr><td><code>--popover-action-height</code></td><td>popover height</td><td><code>44px</code></td></tr><tr><td><code>--popover-hspacing</code></td><td>popover horizontal padding</td><td><code>16px</code></td></tr><tr><td><code>--popover-margin-bottom</code></td><td>popover distance from actual display element\uFF08It takes effect when placement is top, topleft, topright\uFF09</td><td><code>6px</code></td></tr><tr><td><code>--popover-margin-top</code></td><td>popover distance from actual display element\uFF08It takes effect when placement is bottom\u3001bottomleft\u3001bottomright\uFF09</td><td><code>6px</code></td></tr><tr><td><code>--popover-margin-right</code></td><td>popover distance from actual display element\uFF08It takes effect when placement is left\u3001lefttop\u3001leftbottom\uFF09</td><td><code>16px</code></td></tr><tr><td><code>--popover-margin-left</code></td><td>popover distance from actual display element\uFF08It takes effect when placement is right\u3001righttop\u3001rightbottom\uFF09</td><td><code>16px</code></td></tr></tbody></table>`,46),e=[p],d={__name:"doc.en-US",setup(o,{expose:s}){return s({frontmatter:{}}),(h,r)=>(n(),a("div",l,e))}};export{d as default};
