import{c as a,o as t,a as n}from"./vue.5ce4fb01.js";const e={class:"markdown-body"},l=n(`<h1>Checkbox</h1><h3>Intro</h3><p>A group of options for multiple choices.</p><br> To toggle between the checked and unchecked status. <h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Checkbox } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;@quarkd/quark-react&#39;</span>
