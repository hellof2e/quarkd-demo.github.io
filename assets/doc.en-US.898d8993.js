import{d as a,c as n,a as t,o as l}from"./vue.90d6f6a1.js";const p={class:"markdown-body"},e=t(`<h1>ShareSheet</h1><h3>Intro</h3><p>ShareSheet</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> ShareSheet <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;quarkd/lib/sharesheet&#39;</span>;
...
</code></pre>`,19),c=[e],d={},j="",g=a({__name:"doc.en-US",setup(h,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(o,r)=>(l(),n("div",p,c))}});export{g as default,j as excerpt,d as frontmatter};
