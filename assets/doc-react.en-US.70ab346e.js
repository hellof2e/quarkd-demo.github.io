import{c as a,o as n,a as t}from"./vue.07928030.js";const e={class:"markdown-body"},l=t(`<h1>Overlay</h1><h3>Intro</h3><p>Create a mask layer to emphasize specific page elements and prevent users from performing other operations.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Overlay } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
...
</code></pre><h2>API</h2><h3>Props</h3><table><thead><tr><th>Attribute</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td>open</td><td>Whether to show picker</td><td><code>boolean</code></td><td><code>require</code></td></tr><tr><td>zindex</td><td>z-index</td><td><code>number </code></td><td><code>999</code></td></tr><tr><td>onClose</td><td>Close mask</td><td><code>() =&gt; void</code></td><td><code>require</code></td></tr></tbody></table><h2>CSS Variables</h2><p>The component provides the following<a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/Using_CSS_custom_properties">CSS variables</a>,which can be used to customize styles. Please refer to <a href="#/zh-CN/guide/theme">Theme customization</a>\u3002</p><table><thead><tr><th>Name</th><th>Description</th><th>Default Value</th></tr></thead><tbody><tr><td><code>--overlay-background</code></td><td>Mask background</td><td><code>rgba(0, 0, 0, 0.7)</code></td></tr></tbody></table>`,15),p=[l],i={__name:"doc-react.en-US",setup(c,{expose:s}){return s({frontmatter:{}}),(r,h)=>(n(),a("div",e,p))}};export{i as default};
