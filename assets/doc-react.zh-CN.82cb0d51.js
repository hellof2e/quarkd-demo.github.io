import{c as a,o as n,a as t}from"./vue.296e9791.js";const l={class:"markdown-body"},c=t(`<h1>ActionSheet</h1><h3>\u4ECB\u7ECD</h3><p>ActionSheet \u52A8\u4F5C\u9762\u677F</p><h3>\u5B89\u88C5\u4F7F\u7528</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { ActionSheet } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;@quarkd/quark-react&#39;</span>;
...
</code></pre>`,22),p=[c],i={__name:"doc-react.zh-CN",setup(e,{expose:s}){return s({frontmatter:{}}),(h,o)=>(n(),a("div",l,p))}};export{i as default};
