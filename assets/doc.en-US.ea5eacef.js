import{d as a,c as n,a as p,o as t}from"./vue.93d13378.js";const l={class:"markdown-body"},e=p(`<h1>ImagePreview</h1><h3>Intro</h3><p>Basic image preview function</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> imagePreview <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkd/lib/imagepreview&quot;</span>;
...
</code></pre><h3>slot</h3><table><thead><tr><th>Name</th><th>Description</th></tr></thead><tbody><tr><td>name=indicator</td><td>Custom show pages</td></tr></tbody></table>`,31),c=[e],j={},g="",d=a({__name:"doc.en-US",setup(h,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(r,i)=>(t(),n("div",l,c))}});export{d as default,g as excerpt,j as frontmatter};
